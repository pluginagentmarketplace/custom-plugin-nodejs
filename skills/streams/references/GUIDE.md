...
This guide provides comprehensive documentation for the **streams** skill in the custom-plugin-nodejs plugin.
...
```bash
# Invoke the skill
claude "streams - [your task description]"

# Example
claude "streams - analyze the current implementation"
```
...
def implement_streams(input_data):
    """
    Implement streams functionality.

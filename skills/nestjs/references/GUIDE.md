...
This guide provides comprehensive documentation for the **nestjs** skill in the custom-plugin-nodejs plugin.
...
```bash
# Invoke the skill
claude "nestjs - [your task description]"

# Example
claude "nestjs - analyze the current implementation"
```
...
def implement_nestjs(input_data):
    """
    Implement nestjs functionality.

...
This guide provides comprehensive documentation for the **websockets** skill in the custom-plugin-nodejs plugin.
...
```bash
# Invoke the skill
claude "websockets - [your task description]"

# Example
claude "websockets - analyze the current implementation"
```
...
def implement_websockets(input_data):
    """
    Implement websockets functionality.
